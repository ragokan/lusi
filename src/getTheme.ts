...
export default ({ name, colors }: Props) => ({
  name,
  type: "dark",
  colors: {
    focusBorder: colors.dim2,
    foreground: colors.pure2,
    "widget.shadow": colors.activityBarBackground,
    "selection.background": colors.selection,
    descriptionForeground: colors.dim3,
    errorForeground: colors.base1,
    "textBlockQuote.background": colors.terminalBackground,
    "textBlockQuote.border": colors.terminalBackground,
    "textCodeBlock.background": colors.terminalBackground,
    ...
    "button.background": colors.terminalBackground,
    "button.foreground": colors.dim3,
    "button.hoverBackground": colors.codeBackground,
    "dropdown.background": colors.codeBackground,
    "dropdown.listBackground": colors.terminalBackground,
    "dropdown.border": colors.codeBackground,
    "dropdown.foreground": colors.dim3,
    "input.background": colors.inputBackground,
    "input.border": colors.inputBackground,
    "input.foreground": colors.pure2,
    "input.placeholderForeground": colors.dim1,
    "inputOption.activeBorder": colors.dim1,
    "inputValidation.errorBackground": colors.inputBackground,
    "inputValidation.errorBorder": colors.base1,
    "inputValidation.infoBackground": colors.inputBackground,
    "inputValidation.infoBorder": colors.accent1,
    "inputValidation.warningBackground": colors.inputBackground,
    "inputValidation.warningBorder": colors.accent2,
    "scrollbar.shadow": colors.codeBackground,
    ...
    "badge.foreground": colors.codeBackground,
    "badge.background": colors.base2,
    "progressBar.background": colors.terminalBackground,
    "list.activeSelectionBackground": colors.codeBackground,
    ...
    "list.focusBackground": colors.codeBackground,
    ...
    "list.inactiveSelectionBackground": colors.codeBackground,
    "list.inactiveSelectionForeground": colors.base2,
    "list.inactiveFocusBackground": colors.codeBackground,
    ...
    "activityBar.border": colors.activityBarBackground,
    "activityBarBadge.background": colors.base2,
    "activityBarBadge.foreground": colors.codeBackground,
    "sideBar.background": colors.explorerBackground,
    "sideBar.foreground": colors.dim3,
    "sideBar.border": colors.activityBarBackground,
    "sideBar.dropBackground": colors.translucent,
    "sideBarTitle.foreground": colors.dim1,
    "sideBarSectionHeader.background": colors.explorerBackground,
    "sideBarSectionHeader.foreground": colors.dim2,
    "editorGroup.background": colors.activityBarBackground,
    "editorGroup.border": colors.explorerBackground,
    "editorGroup.dropBackground": colors.translucent,
    "editorGroupHeader.noTabsBackground": colors.codeBackground,
    "editorGroupHeader.tabsBackground": colors.codeBackground,
    "editorGroupHeader.tabsBorder": colors.codeBackground,
    "tab.activeBackground": colors.codeBackground,
    "tab.activeForeground": colors.base2,
    "tab.border": colors.codeBackground,
    "tab.activeBorder": colors.base2,
    "tab.unfocusedActiveBorder": colors.dim3,
    "tab.inactiveBackground": colors.codeBackground,
    "tab.inactiveForeground": colors.dim3,
    "tab.unfocusedActiveForeground": colors.dim4,
    "tab.unfocusedInactiveForeground": colors.dim3,
    "tab.hoverBackground": colors.codeBackground,
    "tab.unfocusedHoverBackground": colors.codeBackground,
    "tab.hoverBorder": colors.dim1,
    "tab.unfocusedHoverBorder": colors.codeBackground,
    ...
    "editor.selectionBackground": colors.terminalBackground,
    ...
    "editor.rangeHighlightBackground": colors.terminalBackground,
    "editor.rangeHighlightBorder": colors.terminalBackground,
    "editorWhitespace.foreground": colors.dim1,
    "editorIndentGuide.background": colors.terminalBackground,
    "editorRuler.foreground": colors.dim1,
    "editorCodeLens.foreground": colors.dim2,
    "editorBracketMatch.background": colors.codeBackground,
    ...
    "editorInfo.border": colors.codeBackground,
    "editorHint.foreground": colors.const,
    "editorHint.border": colors.codeBackground,
    "editorGutter.background": colors.codeBackground,
    ...
    "editorWidget.background": colors.terminalBackground,
    "editorWidget.border": colors.terminalBackground,
    "editorSuggestWidget.background": colors.terminalBackground,
    "editorSuggestWidget.border": colors.terminalBackground,
    ...
    "editorHoverWidget.background": colors.terminalBackground,
    "editorHoverWidget.border": colors.codeBackground,
    "debugExceptionWidget.background": colors.terminalBackground,
    "debugExceptionWidget.border": colors.codeBackground,
    "editorMarkerNavigation.background": colors.terminalBackground,
    ...
    "peekView.border": colors.codeBackground,
    "peekViewEditor.background": colors.terminalBackground,
    "peekViewEditorGutter.background": colors.terminalBackground,
    "peekViewEditor.matchHighlightBackground": colors.dim1,
    "peekViewResult.background": colors.terminalBackground,
    ...
    "peekViewTitle.background": colors.terminalBackground,
    ...
    "merge.border": colors.codeBackground,
    "merge.commonHeaderBackground": colors.translucent2,
    "merge.commonContentBackground": colors.translucent3,
    "editorOverviewRuler.border": colors.codeBackground,
    "editorOverviewRuler.currentContentForeground": colors.terminalBackground,
    "editorOverviewRuler.incomingContentForeground": colors.terminalBackground,
    ...
    "panel.background": colors.terminalBackground,
    "panel.border": colors.codeBackground,
    ...
    "statusBar.background": colors.explorerBackground,
    "statusBar.foreground": colors.dim2,
    "statusBar.border": colors.activityBarBackground,
    "statusBar.debuggingBackground": colors.dim2,
    "statusBar.debuggingForeground": colors.pure2,
    "statusBar.debuggingBorder": colors.explorerBackground,
    "statusBar.noFolderBackground": colors.explorerBackground,
    "statusBar.noFolderForeground": colors.dim2,
    "statusBar.noFolderBorder": colors.activityBarBackground,
    "statusBarItem.activeBackground": colors.codeBackground,
    "statusBarItem.hoverBackground": colors.codeBackground,
    "statusBarItem.prominentBackground": colors.terminalBackground,
    "statusBarItem.prominentHoverBackground": colors.terminalBackground,
    "titleBar.activeBackground": colors.explorerBackground,
    ...
    "titleBar.border": colors.activityBarBackground,
    "notificationCenter.border": colors.terminalBackground,
    "notificationCenterHeader.foreground": colors.dim3,
    "notificationCenterHeader.background": colors.terminalBackground,
    "notificationToast.border": colors.terminalBackground,
    "notifications.foreground": colors.dim4,
    "notifications.background": colors.terminalBackground,
    "notifications.border": colors.terminalBackground,
    "notificationLink.foreground": colors.base2,
    "extensionButton.prominentForeground": colors.pure2,
    "extensionButton.prominentBackground": colors.terminalBackground,
    "extensionButton.prominentHoverBackground": colors.dim1,
    "pickerGroup.border": colors.codeBackground,
    "pickerGroup.foreground": colors.dim1,
    "terminal.background": colors.terminalBackground,
    "terminal.foreground": colors.pure2,
    "terminal.ansiBlack": colors.terminalBackground,
    ...
    "debugToolBar.background": colors.terminalBackground,
    "welcomePage.buttonBackground": colors.terminalBackground,
    "welcomePage.buttonHoverBackground": colors.dim1,
    "walkThrough.embeddedEditorBackground": colors.explorerBackground,
